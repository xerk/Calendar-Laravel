...
class RecurringDowngradedMail extends Mailable
{
    ...
    {
        return new Envelope(
            subject: 'Your Grandcalendar.io Yearly Subscription Has Been Canceled',
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.subscribe.recurring-downgraded',
        );
    }
